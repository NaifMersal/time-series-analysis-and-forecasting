...
## $\rightarrow$ Exercise 1.1 · Name the pattern {.sdaia-dark background-gradient="linear-gradient(135deg, #1C355E, #625D9C)"}
...
## $\rightarrow$ Exercise 1.2 · Load, verify, and look {.sdaia-dark background-gradient="linear-gradient(135deg, #1C355E, #625D9C)"}
